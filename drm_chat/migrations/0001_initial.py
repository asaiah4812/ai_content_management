    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_name', models.CharField(default=shortuuid.main.ShortUUID.uuid, max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_messages', to='drm_chat.chatgroup')),
            ],
            options={
                'ordering': ('-created',),
            },
